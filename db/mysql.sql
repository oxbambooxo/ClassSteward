...
-- 默认管理员 admin/admin
insert into user(id,name,passwd,account,regist_time,last_time,photo,class,num) value(1,'管理员','21232f297a57a5a743894a0e4a801fc3','admin',now(),'2014-12-13',25,NULL,0);
